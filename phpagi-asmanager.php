<?php
  ...
  * All Rights Reserved.
  *
  * Modified from jojo61 for Managerinterface Asterisk 14 and above 
  *
  ...
  class AGI_AsteriskManager
  {
    ...
    function wait_response($allow_timeout=false)
    {
      ...
      do
      {
	    ...
	    // store parameter in $parameters
            if (!strncmp($buffer,"Output:",7)) {
              $b = strpos($buffer, '\n');
              $parameters['data'] .= substr($buffer,8);
              $parameters['data'] .= "\n";
            }
            else
    ...
    */
                       ...
                       $timeout=NULL, $callerid=NULL, $variable=NULL, $account=NULL, $async=NULL, $actionid=NULL)
    {
      ...
      /*$parameters['Variable'] = "SIPADDHEADER=Call-Info: <sip:noip>\;answer-after=0";*/
